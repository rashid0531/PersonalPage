...
class ResearchSection extends StatelessWidget {
                ...
                builder: (context, constraints) {
                  ...
                  return Wrap(
                    ...
                    children: PortfolioData.research.map((item) {
                      return _researchCard(context, item, cardWidth, isMobile);
                    }).toList(),
                  );
                },
              ),
  ...
  Widget _researchCard(BuildContext context, ResearchItem item,
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(
                  item.degree.contains('Master') ? 'M.Sc. Thesis' : 'B.Sc. Thesis',
